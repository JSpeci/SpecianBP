...
\TULtitle{Třída sdfgsdfgsfdgsdfgfdg pro \LaTeX\ verze~\verze}{tulthesis \LaTeX\ class version~\verze}
...
\begin{listing}
\prikazneindex{documentclass[FM,BP]\{tulthesis\}}
\end{listing}

zatímco diplomová práce Fakulty strojní

\begin{listing}
\prikazneindex{documentclass[FS,BP]\{tulthesis\}}
\end{listing}
